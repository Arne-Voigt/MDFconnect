...
Alternatively, you could use one of mdf importer/exporter libraries from python, those are often well maintained, and access it through Matlabs python-interface.  
